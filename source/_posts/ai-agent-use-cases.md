...
description: "普通应用是工具，AI 应用是聪明工具，而 AI Agent 应用，是能主动干活、自己决策的“数字员工”。"
...
![](https://bysocket.com/images/ai-agent/ai-agent-vs-ai-app.png)
...
![](https://bysocket.com/images/ai-agent/ai-agent-when.png)
...
![](https://bysocket.com/images/ai-agent/ai-agent-tech.png)
