---
title: Technical SEO 自查清单：10 个真实踩坑案例
...
![图 01：test 子域名和正式官网长得一模一样，Google 分不清谁是正主](https://bysocket.com/images/technical-seo-checklist-10-cases/test-subdomain-duplicate.webp)
...
![图 02：同一份内容挂在 /en 和根路径两个 URL，等于自己跟自己抢权重](https://bysocket.com/images/technical-seo-checklist-10-cases/multi-lang-no-seo.webp)
...
![图 03：抓取预算有限，大量漏给了 404 和 5xx 死链](https://bysocket.com/images/technical-seo-checklist-10-cases/crawl-budget-waste.webp)
...
![图 04：三层修复法，首页单独、模板层一次修、插件单独叠加](https://bysocket.com/images/technical-seo-checklist-10-cases/three-layer-fix.webp)
